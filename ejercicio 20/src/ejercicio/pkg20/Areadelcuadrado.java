 ...
 * @author LDS
 */
public class Areadelcuadrado extends javax.swing.JFrame {

    /**
     * Creates new form Areadelcuadrado
     */
    ...
    private void initComponents() {
        ...
        setTitle("Calcular area del cuadrado");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        lado= Double.parseDouble(jTextField1.getText());
         Operaciones fa = new Operaciones();
        resultado = fa.areadelcuadrado(lado);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Areadelcuadrado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Areadelcuadrado().setVisible(true);
            }
        });
    }
